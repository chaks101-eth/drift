        ...
        <div className="max-w-[1100px] mx-auto px-8 py-8">
          {loading && tab === 'overview' ? (
            ...
            <>
              ...
              {tab === 'agents' && (
                <div className="py-20 text-center">
                  <h2 className="font-serif text-2xl text-[#c8a44e] mb-4">Agent System</h2>
                  <p className="text-sm text-[#7a7a85] mb-2">19 agents across 4 teams — Quality, Generation, Growth, Chief.</p>
                  <p className="text-sm text-[#7a7a85] mb-6">Execute agents, view history, quick actions.</p>
                  <a href="/admin/agents" className="inline-block bg-[#c8a44e] text-[#08080c] px-8 py-3 rounded-xl text-sm font-medium hover:opacity-90 transition-opacity">
                    Open Agent Dashboard &rarr;
                  </a>
                </div>
              )}
              {tab === 'growth' && (
                <div className="py-20 text-center">
                  <h2 className="font-serif text-2xl text-[#c8a44e] mb-4">Growth Engine</h2>
                  <p className="text-sm text-[#7a7a85] mb-2">Generate content, manage queue, post to 5 platforms, track metrics.</p>
...
// Growth + Agents tabs now live at /admin/growth and /admin/agents
