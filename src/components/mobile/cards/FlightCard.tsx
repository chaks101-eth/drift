  ...
  return (
    <div className="relative" onClick={onTap}>
      <div className="relative rounded-2xl border border-drift-border2 bg-drift-card p-4">
        ...
        {/* Transport alternatives (trains/buses alongside flight) */}
        {transportAlts && transportAlts.length > 0 && (
          <div className="mt-3 border-t border-drift-border2 pt-3">
            <div className="mb-2 text-[9px] font-bold uppercase tracking-[0.1em] text-drift-text3">
              Also available
            </div>
            {transportAlts.map((alt, i) => (
              ...
              >
                <div className="flex items-center gap-2">
                  <span className="flex h-5 w-5 items-center justify-center rounded bg-drift-surface2 text-[8px] font-bold text-drift-text3">
                    {alt.mode === 'train' ? 'TR' : 'BU'}
                  </span>
